...
const EMAILJS_SERVICE_ID = "service_ono0ocg";
const EMAILJS_TEMPLATE_ID = "template_ynhrvaq";
const EMAILJS_PUBLIC_KEY = "LEm-TC6FeAaaRHHFq";
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Failed to send. Please email directly: tyesh3651@gmail.com");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <div className="glass-card contact-info-card p-8">
              <h3 className="text-2xl font-semibold text-white mb-6">
                Contact Information
              </h3>
              <p className="text-gray-400 mb-8 leading-relaxed">
                Feel free to reach out for collaborations, internships, or just
                a friendly chat.
              </p>
